// Snapshot of S&P 500 constituent ticker symbols (early 2025).
//
// Only symbols are stored here; CIKs are resolved at runtime against SEC's
// company_tickers.json (see server/seed-sp500.ts) so they stay correct and
// any stale/renamed symbol simply gets skipped. Symbols using "." (e.g.
// BRK.B) are normalized to the SEC's "-" form during resolution.
export const SP500_TICKERS: string[] = [
  ...
  "KMX", "KO", "KR", "KVUE", "L", "LDOS", "LEN", "LH", "LHX", "LII",
